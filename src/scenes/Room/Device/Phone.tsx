...
const PROFILE_IMAGE = '/assets/1787726359442.jpg';
const INSTAGRAM_USERNAME = 'shakila.ai';
const DISPLAY_NAME = 'Shakila';
const PROFILE_BIO = 'Queen of Wonderland ✨\nHappy Birthday 🎂';
    ...
    const htmlInPhone = (
        ...
        >
            <div className={`${styles['android-phone-container']} ${isFullscreen ? styles['fullscreen'] : ''}`}
                ...
                {showScrollHint && (
                    <div className={styles['phone-scroll-hint']}
                        ...
                        <div className={styles['scroll-hint-content']}>
                            ...
                            <div>
                                <div className={styles['hint-title']}>Swipe to explore</div>
                                <div className={styles['hint-subtitle']}>Instagram profile inside the phone 📱</div>
                ...
                {/* instagram app */}
                <div className={styles['instagram-app']}>
                    <header className={styles['ig-header']}>
                        <button className={styles['ig-icon-btn']} aria-label="Back">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                <path d="M15 18l-6-6 6-6" />
                            </svg>
                        </button>
                        <div className={styles['ig-header-user']}>
                            <span className={styles['ig-username']}>{INSTAGRAM_USERNAME}</span>
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M7 10l5 5 5-5H7z" />
                            </svg>
                        </div>
                        <div className={styles['ig-header-actions']}>
                            <button className={styles['ig-icon-btn']} aria-label="Notifications">
                            ...
                            <button
                                className={`${styles['ig-icon-btn']} ${styles['fullscreen-toggle']} ${isFullscreen ? styles['is-active'] : ''}`}
                    ...
                    <div className={styles['ig-content']}>
                        <section className={styles['ig-profile-top']}>
                            <div className={styles['ig-avatar-wrap']}>
                                <img src={PROFILE_IMAGE} alt={DISPLAY_NAME} className={styles['ig-avatar']} />
                            </div>
                            <div className={styles['ig-stats']}>
                                <div className={styles['ig-stat']}>
                                    <strong>24</strong>
                                    <span>posts</span>
                                </div>
                                <div className={styles['ig-stat']}>
                        ...
                        <section className={styles['ig-bio']}>
                            <h2 className={styles['ig-display-name']}>{DISPLAY_NAME}</h2>
                            <p className={styles['ig-bio-text']}>
                                {PROFILE_BIO.split('\n').map((line, i) => (
                        ...
                        <section className={styles['ig-actions']}>
                            <button className={styles['ig-btn']}>Edit profile</button>
                            <button className={styles['ig-btn']}>Share profile</button>
                            <button className={styles['ig-btn-icon']} aria-label="Add friend">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M15 8a3 3 0 1 0-2.83-4H12a5 5 0 1 0 4.9 6H15a3 3 0 1 0 0-6z" />
                                </svg>
                            </button>
                        </section>

                        <section className={styles['ig-highlights']}>
                            {['Birthday', 'Dreams', 'Magic', 'Love'].map((label) => (
                                <div key={label} className={styles['ig-highlight']}>
                                    <div className={styles['ig-highlight-ring']}>
                                        <div className={styles['ig-highlight-inner']} />
                                    </div>
                                    <span>{label}</span>
                                </div>
                            ))}
                        ...
                        <div className={styles['ig-tabs']}>
                            <button className={`${styles['ig-tab']} ${styles['active']}`} aria-label="Posts">
                            ...
                            <button className={styles['ig-tab']} aria-label="Reels">
                                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
                                    <rect x="3" y="3" width="18" height="18" rx="3" />
                                    <path d="M10 8l6 4-6 4V8z" fill="currentColor" stroke="none" />
                                </svg>
                            </button>
                            <button className={styles['ig-tab']} aria-label="Tagged">
                                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
                        ...
                        <section className={styles['ig-grid']}>
                            {Array.from({ length: 9 }, (_, i) => (
                                <div key={i} className={styles['ig-grid-item']}>
                                    {i === 0 ? (
                                        <img src={PROFILE_IMAGE} alt="" className={styles['ig-grid-photo']} />
                                    ) : (
                                        <div className={styles['ig-grid-placeholder']} />
                                    )}
                                </div>
                            ))}
                        </section>
                    ...
                    <nav className={styles['ig-bottom-nav']}>
                        <button className={styles['ig-nav-item']} aria-label="Home">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8h5z" />
                            </svg>
                        </button>
                        <button className={styles['ig-nav-item']} aria-label="Search">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                <circle cx="11" cy="11" r="7" />
                                <path d="M20 20l-3-3" />
                            </svg>
                        </button>
                        <button className={styles['ig-nav-item']} aria-label="Create">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                <rect x="3" y="3" width="18" height="18" rx="4" />
                                <path d="M12 8v8M8 12h8" />
                            </svg>
                        </button>
                        <button className={styles['ig-nav-item']} aria-label="Reels">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                <rect x="3" y="3" width="18" height="18" rx="3" />
                                <path d="M10 8l6 4-6 4V8z" fill="currentColor" stroke="none" />
                            </svg>
                        </button>
                        <button className={`${styles['ig-nav-item']} ${styles['active']}`} aria-label="Profile">
                            <img src={PROFILE_IMAGE} alt="" className={styles['ig-nav-avatar']} />
                        </button>
                    </nav>
                </div>
            </div>
